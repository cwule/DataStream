...
namespace Epiphan.FrmGrab
{
    ...
    public class FrameGrabber
    {
        ...
        //[DllImport("C:/Users/BDML-Haptics/Documents/Visual Studio 2017/Projects/EpiphanAPI/epiphan/frmgrab/bin/win/x64/frmgrab.dll",
        //   CallingConvention = CallingConvention.Cdecl)]
        //static extern int FrmGrabLocal_Count();
        ...
        //    CallingConvention = CallingConvention.Cdecl)]
        //static extern unsafe void FrmGrab_Release(IntPtr fg, V2U_GrabFrame2* frame);
        const string dllPath = "../../../../frmgrab/bin/win/x64/frmgrab.dll";
        //const string dllPath = "C:/Users/BDML-Haptics/Documents/Visual Studio 2017/Projects/EpiphanAPI/epiphan/frmgrab/bin/win/x64/frmgrab.dll";
        [DllImport(dllPath,
        CallingConvention = CallingConvention.Cdecl)]
        static extern int FrmGrabLocal_Count();
    ...
    public unsafe class Frame
    {
        ...
        /// <summary>
        /// Returns Texture representation of this frame. TODO
        /// </summary>
