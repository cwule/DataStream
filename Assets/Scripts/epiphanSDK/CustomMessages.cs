...
namespace HoloToolkit.Sharing.Tests
{
    ...
    public class CustomMessages : Singleton<CustomMessages>
    {
        ...
        {
            ImageData = MessageID.UserMessageIDStart,
            Max
        }
        ...
        private void InitializeMessageHandlers()
        {
            ...
            for (byte index = (byte)EpiphanMessageID.ImageData; index < (byte)EpiphanMessageID.Max; index++)
            {
        ...
        public void SendHeadTransform(Vector3 position, Quaternion rotation)
        {
            ...
            if (serverConnection != null && serverConnection.IsConnected())
            {
                ...
                NetworkOutMessage msg = CreateMessage((byte)EpiphanMessageID.ImageData);
